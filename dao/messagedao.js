...
/**
 * [getDetailMessageById 通过tid获取消息及详细]
 * @param  {[type]}   id
...
/**
 * [getCountOfMessageByUid description]
 * @param  {[type]}   uid
 * @param  {[type]}   isread
 * @param  {Function} callback
 * @return {[type]}
