/*! Amaze UI v2.5.2 | by Amaze UI Team | (c) 2016 AllMobilize, Inc. | Licensed under MIT | 2016-01-26T11:06:52+0800 */ ! function(t, e) {
	...
	return function(t) {
		...
		var s = n.AMUI || {},
			...
			a = window.document,
			r = n("html");
		s.VERSION = "2.5.2", s.support = {}, s.support.transition = function() {
			var t = function() {
					...
					controlNav: {
						...
						setupPaging: function() {
							var t, e, i = "thumbnails" === s.vars.controlNav ? "control-thumbs" : "control-paging",
								o = 1;
							if (s.controlNavScaffold = n('<ol class="' + a + "control-nav " + a + i + '"></ol>'), s.pagingCount > 1)
					...
					touch: function() {
						...
						function o(e) {
							if (t.removeEventListener("touchmove", n, !1), s.animatingTo === s.currentSlide && !b && null !== w) {
								var i = d ? -w : w,
									a = i > 0 ? s.getTarget("next") : s.getTarget("prev");
		...
		c.DEFAULTS = {
			...
			if (!this.active && this.$element.length) {
				t && (this.relatedTarget = t), this.transitioning && (clearTimeout(e.transitionEndTimmer), e.transitionEndTimmer = null, e.trigger(i.transitionEnd).off(i.transitionEnd)), n && this.$element.show(), this.active = !0, e.trigger(s.Event("open.modal.amui", {
					relatedTarget: t
				})), this.dimmer.open(e), e.show().redraw(), n || this.isActions || (o && (o = parseInt(o, 10), r.width = o + "px", r.marginLeft = -parseInt(o / 2) + "px"), a ? (a = parseInt(a, 10), r.marginTop = -parseInt(a / 2) + "px", this.$dialog.css({
					height: a + "px"
				})) : r.marginTop = -parseInt(e.height() / 2, 10) + "px", e.css(r)), e.removeClass(i.className.out).addClass(i.className.active), this.transitioning = 1;
				var c = function() {
