(function(e) {
    ...
    function f() {
        var t = s.parent("div").prev();
        if (t.length == 0) {
            t = e(".gallery div:last-child")
        }
        t.find("a").trigger("click")
    }

    function l() {
        var t = s.parent("div").next();
        if (t.length == 0) {
            t = e(".gallery div:first-child")
        }
    ...
    (function() {
        ...
        e("#zoom .close").on("click", c);
        e("#zoom .previous").on("click", f);
        e("#zoom .next").on("click", l);
        e(document).keydown(function(e) {
            ...
            if (e.which == 37 && !s.hasClass("zoom")) {
                f()
            }
            if (e.which == 39 && !s.hasClass("zoom")) {
                l()
            }
        });
        if (e(".gallery a").length == 1) {
            e(".gallery a")[0].addClass("zoom")
        }
        e(".zoom, .gallery a").on("click", a)
    })();
    (function() {
